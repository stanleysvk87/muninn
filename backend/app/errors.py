...
_MESSAGES: dict[str, str] = {
    ...
    "folder_not_absolute": "Cesta musí byť absolútna (začínať /)",
    "folder_too_broad": "Priečinok {path} je príliš široký — sledovanie by presunulo do archívu všetko, čo v ňom je. Vyber konkrétny podpriečinok.",
    "folder_is_app_storage": "Priečinok {path} patrí samotnému Muninnu (archív/dáta) — sledovať sa nedá",
    "folder_not_empty": "V priečinku {path} je už {count} súborov. Registráciou sa VŠETKY odošlú AI poskytovateľovi a fyzicky presunú do archívu. Potvrď, ak to naozaj chceš.",
    "upload_unsupported_format": "Nepodporovaný typ súboru: {suffix}",
    "upload_too_large": "Súbor je väčší než povolený limit {limit_mb} MB",
    "invalid_search_query": "Neplatný vyhľadávací výraz",
    "too_many_attempts": "Príliš veľa pokusov — skús znova o {seconds} s",
    "bootstrap_token_invalid": "Neplatný alebo chýbajúci setup token (nájdeš ho na serveri v data/bootstrap-token.txt)",
